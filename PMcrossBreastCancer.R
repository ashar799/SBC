...
##### This file Runs a SINGLE RUN FOR the cross validation 5 times cross validation on the Breast Cancer Data Set ####
...
set.seed(42*u)
#### Define the folds
folds <- createFolds(c.vijver, k = 5, list = TRUE, returnTrain = FALSE)
test.index <- folds[[v]]
####################
...
filename <- paste('/home/bit/ashar/ExpressionSets/CROSS_VALIDATION/Breast/','repeat',u,'split',v,'.RData',sep = "")
save(list =ls(), file = filename)



#### Add these two extra methods
load("/home/bit/ashar/ExpressionSets/CROSS_VALIDATION/Breast/repeat1split1.RData")
