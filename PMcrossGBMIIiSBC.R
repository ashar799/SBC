...
##### The normal i-SBC code is tested #####
...
filename <- paste('/home/bit/ashar/ExpressionSets/CROSS_VALIDATION/GBMII/','repeat',u,'split',v,'.RData',sep = "")
save(list =ls(), file = filename)


#### Add these two extra methods
load("/home/bit/ashar/ExpressionSets/CROSS_VALIDATION/GBMII/repeat1split1.RData")
